...
import { postTiktokView } from '../../api/tiktokAPI';

const TiktokViewScreen = () => {
    ...
    const handleBuyButtonPress = async() => {
        ...
        const res = await postTiktokView(memoryCode, path, quantity);
        console.log(res);
    ...
    return (
        <View style={styles.container}>
            <View style={styles.resultContainer}>
                <Text style={styles.resultLabel}>Tăng view video</Text>
            </View>
...
export default  TiktokViewScreen    ;
