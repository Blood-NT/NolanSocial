...
import { postTiktokShareLive } from '../../api/tiktokAPI';

const TiktokShareLiveScreen = () => {
    ...
    const handleBuyButtonPress = async() => {
        ...
        const res = await postTiktokShareLive(memoryCode, path, quantity);
        console.log(res);
    ...
    return (
        <View style={styles.container}>
            <View style={styles.resultContainer}>
                <Text style={styles.resultLabel}>Tăng share live tiktok</Text>
            </View>
...
export default  TiktokShareLiveScreen    ;
