...
import { postINSLike } from '../../api/instagramAPI';
...
const InsLikeScreen = () => {
    ...
    const handleBuyButtonPress = async() => {
       const res = await postINSLike(memoryCode, path, quantity);
        console.log(res);
    };
    ...
    return (
        <View style={styles.container}>
            <View style={styles.resultContainer}>
                <Text style={styles.resultLabel}>Tăng like bài viết Instagram</Text>
            </View>
