...
import { postINSLikeCmt } from '../../api/instagramAPI';

const InsLikeCMTScreen = () => {
    ...
    const handleBuyButtonPress = async() => {
        const res = await postINSLikeCmt(memoryCode, path, quantity);
        console.log(res);
    };
    ...
    return (
        <View style={styles.container}>
            <View style={styles.resultContainer}>
                <Text style={styles.resultLabel}>Tăng like comment instagram</Text>
            </View>
...
export default  InsLikeCMTScreen    ;
